...
public class OpticalDevices  implements Serializable {
    ...
    public static class Builder {
        ...
        public Builder copy(OpticalDevices opticalDevices) {
            this.id = opticalDevices.id;
            this.Name = opticalDevices.Name;
            this.Description = opticalDevices.Description;
            this.Stock = opticalDevices.Stock;
            this.Price = opticalDevices.Price;
            return this;
        }
